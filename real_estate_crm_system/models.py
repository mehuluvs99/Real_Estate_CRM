...
class Add_Inquiry(models.Model):
    ...
    inquiry_type = models.ForeignKey(Inquiry_Type, on_delete=models.CASCADE)
    inquiry_stage = models.ForeignKey(Inquiry_Stage, on_delete=models.CASCADE)
    ...
    follow_up_date = models.DateTimeField(max_length=50, blank=True, null=True)
    remarks = models.TextField(max_length=200, blank=True, null=True)
    next_follow_up_date = models.DateTimeField(max_length=50, blank=True, null=True)
    converted_date = models.DateTimeField(max_length=50, blank=True, null=True)
    assign_to = models.ForeignKey(Assign_To, on_delete=models.CASCADE)
